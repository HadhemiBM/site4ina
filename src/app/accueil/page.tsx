...
//  // Change splash duration (currently 5000ms)
// // Change splash duration (currently 5000ms)
// useEffect(() => {
//   const timer = setTimeout(() => {
//     setShowSplash(false);
//     // Start showing content halfway through splash exit animation
...
//                 duration:1, 
//                 ease: "easeInOut",
//                 // Delay content appearance until halfway through exit
//                 onUpdate: (latest: { opacity: number }) => {
//                   if (latest.opacity < 0.5 && !showContent) {
//                     setShowContent(true);
//                   }
//                 }
//               },
...
//               <TextRevealCard
//                 data-aos="fade-up"
//                 text="Do You Really Know Where Your Energy Is Going?"
...
//                     suffix="%"
//                   />
//                   <h5>Increased Productivity Time</h5>
//                 </div>
...
//                     suffix="%"
//                   />
//                   <h5>Reduction in Lost Time Duties</h5>
//                 </div>
//                 <div className={styles.column}>
//                   <CountUp
//                     className={styles.count}
...
//                 duration: 1,
//                 ease: "easeInOut",
//                 // Start halfway through splash exit
//                 delay: 0.8 
//               }
//             }}
//           >
...
//                       Our expertise spans agriculture, manufacturing,
//                       healthcare, and hospitality. From small businesses to
//                       large enterprises, we provide scalable and adaptive
//                       AI-powered energy solutions aligned with Industry 4.0
//                       standards.
//                     </p>
//                   </div>
...
//                         Our precision sensors collect real-time energy usage
//                         data continuously , seamlessly connecting with our
//                         platform to provide a clear, data-driven view of your
...
//                         Our cloud-based software analyzes data from each device
//                         and offers intelligent automation that adapts to your
//                         energy needs, providing easy, remote access ( Web &
//                         Mobile) to insights while optimizing consumption and
//                         minimizing waste
//                       </p>
//                     </div>
//                     <div className={styles.disc2}></div>
//                   </div>
//                 </div>
//               </div>
...
//                 <p className={styles.SolutionsDesc}>
//                   Schedule a personalized demo with our experts to explore how
//                   we can help you optimize energy usage, reduce costs, and drive
//                   sustainable growth
//                 </p>
...
//                     <button
//                       className={styles.scrollButton1}
//                       onClick={scrollLeft1}
//                     >
//                       <Image
//                         src={arrowLeft}
...
//                   Together, we leverage our strengths to create cutting-edge
//                   solutions that drive success across various sectors.
//                 </p>
  ...
  <div className={styles.card + ' ' + styles.card4}>
    ...
    alt="Smart Capital" />
      ...
      <div className={styles.PricingSection}>
        ...
        <p className={styles.SolutionsDesc}>
        Scalable offerings, from simple visualization to intelligent AI optimization.
        </p>
        <div className={styles.AllPrices}>
          <div className={styles.price1}>
            <div className={styles.rowloa}>
