    ...
    <div className={styles.container}>
      ...
      <div className={styles.CibleSection}>
        <div className={styles.CibleLeft}>
          <h1 className={styles.CibleTitle}>
            Targeting All Industries, Any Company Size
          </h1>
        ...
        <div className={styles.CibleRight}>
          <div className={styles.SpinnerWrapper}>
            <div className={styles.row1}>
              <p className={styles.SpinnerDesc}> Industrial companies</p>
            ...
            <div className={styles.row2}>
              <p className={styles.SpinnerDesc}>Agriculture companies</p>
              <div className={styles.Spinner}>
                <Image
                  src={SpinnerImage}
                  alt="Spinner"
            ...
            <div className={styles.row3}>
              <p className={styles.SpinnerDesc}>Hospitals</p>
              <div className={styles.Spinner}>
                <Image
                  src={SpinnerImage}
                  alt="Spinner"
      ...
      <div className={styles.SolutionSection}>
        ...
        <p className={styles.SolutionsDesc}>
          We create custom energy management solutions tailored to your unique
          needs, from energy efficiency upgrades to advanced analytics
        </p>
        <div className={styles.AllSolutions}>
          <div className={styles.Solution2}>
            <div className={styles.SolutionCircle}>
              <Image className={styles.Image} src={hardware} alt="hardware" />
            </div>
            <h3 className={styles.SolTitle1}>Hardware</h3>
            <p className={styles.SolutionDesc1}>
              Our advanced sensors collect real-time energy usage data and sends
              information directly to our software.
            </p>
          </div>
          <div className={styles.Solution1}>
            <div className={styles.SolutionCircle}>
              <Image className={styles.Image} src={software} alt="hardware" />
            </div>
          ...
          <div className={styles.Solution2}>
            <div className={styles.SolutionCircle}>
              <Image className={styles.Image} src={algo} alt="hardware" />
            </div>
            <h3 className={styles.SolTitle1}>Algorithms</h3>
            <p className={styles.SolutionDesc1}>
      ...
      <div className={styles.DemoSection}>
        ...
        <p className={styles.SolutionsDesc}>
          Book a demo now and discover how we can elevate your operations. Don’t
          wait, experience the future of efficiency and performance!
        </p>
      ...
      <div className={styles.ServicesSection}>
        ...
        <p className={styles.SolutionsDesc}>
          We work closely with you to ensure seamless implementation and ongoing
          success, empowering you to optimize performance and achieve your
          goals.
        </p>
        <div className={styles.AllServices}>
          ...
          <div className={styles.Service1}>
            ...
            <div className={styles.ServiceContent}>
              <h6 className={styles.ServiceTitle}>Smart device Based on IA</h6>
              <p className={styles.ServiceDesc}>
                Electrical device with an HMI screen with a local application
                based on HMI
              </p>
            </div>
          </div>
          ...
          <div className={styles.Service1}>
            ...
            <div className={styles.ServiceContent}>
              ...
              <p className={styles.ServiceDesc}>
                ...
                energy consumption, technical assistance by AI, prediction of
                future consumption, factory and workshop management.{" "}
              </p>
            </div>
          </div>
          {/* service5 */}
